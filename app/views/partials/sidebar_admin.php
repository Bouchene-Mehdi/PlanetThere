...
<section class="side-bar-section">
        <ul class="side-bar">
            ...
            <li class="side-bar-element">
                <img src="assets/images/sidebarpics/user.png" class="side-bar-element-picture">
                <a href="AdminUsers" class="side-bar-element-text text">User managment</a>
            </li>

            <li class="side-bar-element">
                <img src="assets/images/sidebarpics/chart.png" class="side-bar-element-picture">
                <a href="AdminEvent" class="side-bar-element-text text">Accepted events</a>
            </li>

            <li class="side-bar-element">
                <img src="assets/images/sidebarpics/card.png" class="side-bar-element-picture">
                <a href="AdminBanned" id="banned-users" class="side-bar-element-text text">Banned users</a>
            </li>
